...
public enum GameState implements Serializable {
    ...
    CREWMATE_ASKING("[name]! Наконец-то! Мы долго ждали, пока ты проснёшься! Нам предстоит тяжёлая миссия."),

    MISSION("""
            Да, миссия! Несколько лет назад учёные получили неопознанные сигналы отсюда, и вот мы тут.<br>
            Наша задача – <b>узнать всё о живущих тут существах, вернуться на Землю и предоставить нашим учёным все данные.</b><br>
    ...
    SLEEPING("""
            Да, нас погрузили в сон на время полёта.<br>
            Несколько лет назад учёные получили неопознанные сигналы отсюда и отправили нас.<br>
            Наша задача – <b>узнать всё о живущих тут существах, вернуться на Землю и предоставить нашим учёным все данные.</b><br>
            Ты долго спал, видимо, память ещё не до конца восстановилась.<br>
            Думаю, тебе стоит отдохн...<br>
            <br>
    ...
    ALIENS_PARTY("""
               – Здавстуй, дорокой дуг! – отвечает пришелец...<br>
            <br>
            Вы, как и ваши напарники по экипажу, изумлённо смотрите на инопланетных существ.<br>
            <br>
    ...
    VICTORY("""
            ...
            Земным учёным ещё долго предстоит с ними разбираться.""");
    ...
    public void setCustomLoseMessage(GameState previousState) {
        ...
        this.message = switch (previousState) {
            ...
            case MISSION, SLEEPING -> """
                    ...
                    Инопланетный корабль вскоре отстыковался и улетел, а вы не получили никакой информации.""";
            case ALIENS_MEETING -> """
                    Инопланетные существа были глубоко обижены вашим жестом.<br>
                    А в ответ уничтожили ваш корабль.""";
            case ALIENS_PARTY -> """
                    Вы остались с инопланетянами, а учёные на Земле так и остались в неведении.<br>
